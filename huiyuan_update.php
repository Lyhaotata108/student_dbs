...
$xinid = empty($_GET['xinid'])?"null":$_GET['xinid'];
	if ($xinid=="null") {
		...
		include("conn.php");
		// 找到班级的hid这行代码
		$sql="select * from user where id='{$xinid}'";
		  ...
		  <div class="content">
			...
			<form class="sui-form form-horizontal sui-validate" action="huiyuan_save.php" method="post">
			  <div class="control-group">
			    ...
			    <div class="controls"> 
			    <input type="hidden" value="<?php echo $row['id']; ?>" name="xinid">
			     <input type="hidden" value="update" name="action">
			      <input type="text" id="huiMing" class="input-large input-fat"  placeholder="输入用户名" data-rules="required|minlength=2|maxlength=10" name="yhname" value="<?php echo $row['name']; ?>">
			    </div>
			  </div>
			  <div class="control-group">
			  ...
			  <div class="control-group">
			    <label for="question" class="control-label">隐私问题：</label>
			    <div class="controls">
			  ...
			  <div class="control-group">
			    <label for="answer" class="control-label">隐私答案</label>
			    <div class="controls">
